...
@RestController
@RequestMapping("/proyectiva")
public class PruebasProyectivas {

    private final ChatClient chatClient;
    private final VectorStore vectorStore;

    @Value("classpath:prompts/proyectivas.ai.st")
    private Resource stPromptTemplate;

    public PruebasProyectivas(ChatClient.Builder chatBuilder, VectorStore vectorStore) {
